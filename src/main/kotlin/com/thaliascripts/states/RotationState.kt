...
import com.thaliascripts.states.rotationfunctions.RandomRotation
import com.thaliascripts.states.rotationfunctions.Rotation
...
class RotationState(rotateToAngleYaw: Float, rotateToAnglePitch: Float, ticks: Int) : StateSeries(emptyList()) {
    ...
    open class RotationTickState(protected var rotateToYaw: Float, protected var rotateToPitch: Float) : State() {
        override fun onStart() {
